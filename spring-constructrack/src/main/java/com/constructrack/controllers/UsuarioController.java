...
@Slf4j
@Tag(name = "Usuarios", description = "Endpoints para gestionar perfiles de usuario")
...
public class UsuarioController {
    ...
    public ResponseEntity<ApiResponseDTO<List<Usuario>>> obtenerTodos() {
        try {
            List<Usuario> usuarios = usuarioService.obtenerTodosUsuarios();

            return ResponseEntity.ok(ApiResponseDTO.<List<Usuario>>builder()
                    .exito(true)
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(ApiResponseDTO.<List<Usuario>>builder()
                            .exito(false)

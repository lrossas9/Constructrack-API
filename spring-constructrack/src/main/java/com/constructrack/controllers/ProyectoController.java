...
/**
 * Controlador de Proyectos - Gestiona operaciones CRUD de proyectos y actividades
 * 
 * Endpoints:
...
public class ProyectoController {
    ...
    @Operation(
            ...
            description = "Crea un nuevo proyecto de construcción (Implementa RF01)",
            responses = {
    ...
    @Operation(
            ...
            description = "Retorna la lista completa de proyectos",
            responses = {
    ...
    @Operation(
            summary = "Obtener avance del proyecto",
            description = "Retorna el avance actual del proyecto en tiempo real (Implementa RF02)",
            responses = {
                    @ApiResponse(responseCode = "200", description = "Avance obtenido exitosamente",
                            content = @Content(mediaType = "application/json",
                                    schema = @Schema(implementation = ApiResponseDTO.class))),
                    @ApiResponse(responseCode = "401", description = "No autenticado"),
                    @ApiResponse(responseCode = "404", description = "Proyecto no encontrado")
    ...
    @Operation(
            summary = "Obtener actividades del proyecto",
    ...
    @Operation(
            ...
            description = "Elimina un proyecto y todas sus actividades asociadas",
            responses = {
